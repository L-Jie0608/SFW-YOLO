...
classes = ['Undercut', 'Weld bead', 'Hole', 'Inclusion']


parser = argparse.ArgumentParser()
parser.add_argument('--image_path', type=str, default='E:\\1\\XW2\\val\\images', help="path of images")
parser.add_argument('--label_path', type=str, default='E:\\1\\XW2\\val\\labels', help="path of labels .txt")
parser.add_argument('--save_path', type=str, default='E:\\1\\XW2\\output\\data.json', help="path to save the json file")
